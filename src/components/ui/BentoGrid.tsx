  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: 'linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(237,179,241,1) 35%, rgba(0,212,255,1) 100%)'
      }}
    >
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        <div className={cn(
          ...
          {id === 2 && <p>hi i used to be a globe lol</p>}
