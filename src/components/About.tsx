...
const About = () => {
  return (
    <div className="h-[90vh] w-screen bg-[#8EAEC7] text-white flex flex-col px-8
     ...
     via-90% overflow-hidden" id="about">
      ...
      <section className="flex p-4 mt-5 lg:mt-10 w-full max-w-7xl">
        ...
        <div className="flex flex-col justify-between items-start h-full ml-8 lg:ml-16">
          ...
          <p className="about-body">
            I took a leap and pursued a <a href="https://www.uwb.edu/stem/undergraduate/majors/bscsse"
              target="_blank">Bachelor&apos;s in Computer Science at the University of Washington</a>, where
